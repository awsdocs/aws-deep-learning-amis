# Release Note Details for Deep Learning AMI \(Amazon Linux\) Version 2\.0<a name="dlami-conda-amazon-linux-latest"></a>
...
## Testing the Frameworks<a name="dlami-conda-amazon-linux-latest-testing-frameworks"></a>
