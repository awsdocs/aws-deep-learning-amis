# Deep Learning AMI with Source Code \(CUDA 9, Amazon Linux\) Version: 2\.0<a name="dlami-source-amazon-linux-latest"></a>
...
## GPU Drivers Installed<a name="dlami-source-amazon-linux-latest-gpu-drivers"></a>
+ CuDNN 7
+ Nvidia 384\.81
+ CUDA 9\.0
