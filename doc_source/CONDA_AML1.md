# Release Note Details for Deep Learning AMI \(Amazon Linux\) Version 1\.0<a name="CONDA_AML1"></a>
...
## Deep Learning AMI \(Amazon Linux\) Known Issues<a name="CONDA_AML1-known-issues"></a>
