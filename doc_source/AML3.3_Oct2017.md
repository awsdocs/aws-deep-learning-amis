# Deep Learning AMI Amazon Linux Version: 3\.3\_Oct2017<a name="AML3.3_Oct2017"></a>
...
## Python 2\.7 and Python 3\.4 Support<a name="pythonsupport-7"></a>

Python 2\.7 and Python 3\.4 are supported in the AMI for the following Deep Learning Frameworks:
...
## Testing the Frameworks<a name="testing-frameworks-7"></a>
