# Deep Learning AMI Amazon Linux Version: 2\.0<a name="AML2_0"></a>

## Deep Learning Amazon Machine Image<a name="dplami-2"></a>
...
## Pre\-built Deep Learning Frameworks<a name="pdlf-2"></a>
...
## Python 2\.7 and Python 3\.5 Support<a name="pythonsupport-2"></a>
...
## CPU Instance Type Support<a name="cpu-instance-2"></a>
...
## CNTK Python Support<a name="cntk-pythonsupport-2"></a>
...
## GPU Drivers Installed<a name="gpu-drivers-2"></a>
...
## Launching Deep Learning Instance<a name="launching-dl-2"></a>
...
## Testing the Frameworks<a name="testing-frameworks-2"></a>
...
## Amazon Linux AMI<a name="amazonlinuxami-2"></a>
...
## References<a name="references-2"></a>
